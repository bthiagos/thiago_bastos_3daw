							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-danger delete_cat" type="button" data-id="<?php echo $row['id'] ?>">Deletar</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.delete_cat').click(function(){
		_conf("Tem certeza que deseja deletar esta categoria?","delete_cat",[$(this).attr('data-id')])
	})
