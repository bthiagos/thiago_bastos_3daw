				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Menu Nome</label>
								<input type="text" class="form-control" name="name">
							</div>
							<div class="form-group">
								<label class="control-label">Menu Descrição</label>
							...
							<div class="form-group">
								<div class="custom-control custom-switch">
								  ...
								  <label class="custom-control-label" for="availability">Disponível</label>
								</div>
							</div>	
							<div class="form-group">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										...
										<p>Descrição: <b class="truncate"><?php echo $row['description'] ?></b></p>
										<p>Preço: <b><?php echo "$".number_format($row['price'],2) ?></b></p>
									</td>
									<td class="text-center">
										...
										<button class="btn btn-sm btn-danger delete_menu" type="button" data-id="<?php echo $row['id'] ?>">Deletar</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('#manage-menu').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("Dados adicionados com sucesso",'success')
					setTimeout(function(){
						location.reload()
					},1500)
					...
					alert_toast("Dados atualizados com sucesso",'success')
					setTimeout(function(){
						location.reload()
					},1500)
	...
	$('.delete_menu').click(function(){
		_conf("Tem certeza de que deseja excluir este menu?","delete_menu",[$(this).attr('data-id')])
	})
