...
<div class="container-fluid">
	...
	<div class="card ">
        ...
        <div class="card-body">
          ...
          <div class="row">
          	<div class="col-md-2"><label class="control-label">Qtd</label></div>
          ...
          <div class="text-center">
          	<button class="btn btn-outline-primary btn-sm btn-block" id="add_to_cart_modal"><i class="fa fa-cart-plus"></i> Adicionar ao Carrinho</button>
          </div>
        </div>
	...
	$('#add_to_cart_modal').click(function(){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1 )
					alert_toast("Pedido adicionado com sucesso ao carrinho");
