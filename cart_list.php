 			...
 			<div class="col-lg-8">
 				<div class="sticky">
 					<div class="card">
 						<div class="card-body">
 							<div class="row">
 								<div class="col-md-8"><b>Produto</b></div>
 						...
 						<div class="card-body">
 							<div class="row">
 								...
 								<div class="col-md-4">
 									...
 									<p class='truncate'> <b><small>Descrição: <?php echo $row['description'] ?></small></b></p>
 									<p> <b><small>Preço unidade: <?php echo "R$ " . number_format($row['price'], 2) ?></small></b></p>
 								...
 								<div class="col-md-4 text-right">
 									<b>
 										<large><?php echo "R$ " . number_format($row['qty'] * $row['price'], 2) ?></large>
 									</b>
 								</div>
 							</div>
 						</div>
 			...
 			<div class="col-md-4">
 				<div class="sticky">
 					<div class="card">
 						<div class="card-body">
 							<p>
 								<large>Valor Total</large>
 							</p>
 							<hr>
 							<p class="text-right"><b><?php echo "R$ " . number_format($total, 2) ?></b></p>
 							<hr>
 							<div class="text-center">
 								<button class="btn btn-block btn-outline-primary" type="button" id="checkout">Fazer o checkout</button>
 							</div>
 						</div>
 					</div>
 				</div>
 ...
 <script>
 	$('.view_prod').click(function() {
 		uni_modal_right('Produto', 'view_prod.php?id=' + $(this).attr('data-id'))
 	})
